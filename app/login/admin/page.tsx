...
export default function SuperAdminLogin() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // For now, we'll just redirect to the super admin dashboard
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1B2A4E] to-[#19A5A2] flex flex-col justify-center items-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        ...
        <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">Super Admin Login</h2>
        ...
        <div className="mt-6 text-center">
          <Link href="/login/student" className="text-sm text-[#19A5A2] hover:underline">
            Student Login
          </Link>
          {" | "}
