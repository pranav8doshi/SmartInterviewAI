    ...
    <TooltipProvider>
      <div className="h-screen flex flex-col bg-[#202124] text-white overflow-hidden">
        <main className="flex-1 relative">          
          ...
          <div className="absolute inset-4 rounded-lg bg-[#3c4043] overflow-hidden flex justify-between items-center h-full">
  {/* Left Side: Recorded Video */}
    ...
    {stream && isVideoEnabled ? (
      ...
      <div className="w-24 h-24 rounded-full bg-[#5f6368] flex items-center justify-center text-3xl">
        V
          ...
          <div className="absolute bottom-5 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-[#202124] p-2 rounded-lg">
            <Tooltip>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full w-12 h-12 bg-[#3c4043] hover:bg-[#4a4d51]"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button variant="ghost" size="icon" className="rounded-full w-12 h-12 bg-red-500 hover:bg-red-600">
